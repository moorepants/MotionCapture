...
\begin{figure}
    \centering
        \includegraphics[width=\textwidth]{treadmill.jpg}
...
\begin{figure}
    \centering
        \subfloat[]{\label{fig:jodiBikeMarkers}\includegraphics[height=88mm]{jodiBikeMarkers.pdf}}
        \subfloat[]{\label{fig:jodiMarkers}\includegraphics[height=88mm]{jodiMarkers.pdf}}
...
\begin{figure}
    \centering
        \includegraphics[width=80mm]{markerLoc.pdf}
...
\begin{figure}[]
    \begin{center}
        \includegraphics[width=\textwidth]{eigPlot.pdf}
    \end{center}
...
\begin{figure}[tb]
    \begin{center}
        \subfloat[]{\label{fig:coef3062}\includegraphics[width=0.5\textwidth]{coef3062.pdf}}
        \subfloat[]{\label{fig:fft3062}\includegraphics[width=0.5\textwidth]{fft3062.pdf}}
    \end{center}
...
\begin{figure}[]
    \begin{center}
        \subfloat[]{\label{fig:steerRoll}\includegraphics[width=25mm]{rollSteer.pdf}}\qquad
        \subfloat[]{\label{fig:yaw}\includegraphics[width=25mm]{yaw.pdf}}\qquad
        \subfloat[]{\label{fig:pedaling}\includegraphics[width=25mm]{pedal.pdf}}\qquad
        \subfloat[]{\label{fig:bend}\includegraphics[width=25mm]{bend.pdf}}
        
        \subfloat[]{\label{fig:lean}\includegraphics[width=25mm]{lean.pdf}}\qquad
        \subfloat[]{\label{fig:twist}\includegraphics[width=25mm]{twist.pdf}}\qquad
        \subfloat[]{\label{fig:bounce}\includegraphics[width=25mm]{bounce.pdf}}\qquad
        \subfloat[]{\label{fig:knees}\includegraphics[width=25mm]{knees.pdf}}
    \end{center}
...
The correlated coefficients were used to form six different classes of motions, each made up of combinations of the previously described motions, with reference to Fig. (\ref{fig:motions}):
...
\begin{figure}[]
    \centering
    \includegraphics[width=\textwidth]{pedaling4classes.pdf}
...
\begin{figure}[tb]
    \centering
        \includegraphics[width=\textwidth]{steerangle.pdf}\\
...
\begin{figure}[tb]
    \centering
        \includegraphics[width=\textwidth]{towing3classes.pdf}\\
...
\begin{figure}[]
    \centering
        \includegraphics[width=\textwidth]{steerangletowing.pdf}\\
...
\label{eq:b2}
\end{equation}
The heading vector of the rear frame is then $\hat{\mathbf{b}}_1=\hat{\mathbf{b}}_2\times\hat{\mathbf{n}}_3$ and $\hat{\mathbf{b}}_3=\hat{\mathbf{b}}_1\times\hat{\mathbf{b}}_2$ follows. These unit vectors define a reference frame that leans and yaws with the rear frame. We assumed that the rear frame pitch is negligible. The marker locations of the rider can now be expressed in the $\mathbf{B}$ frame with reference to a point on the rear frame $m_{36}$, Eq. (\ref{eq:wrtRear}), and these were used in the PCA of the rider only markers.
\begin{equation}
    \mathbf{r}^{{m_{k}}/m_{36}}=
...
\label{eq:e2}
\end{equation}
The handlebar/fork frame rotates around $\hat{\mathbf{d}}_3=\hat{\mathbf{e}_3}$ and then $\hat{\mathbf{e}}_1=\hat{\mathbf{e}}_3\times\hat{\mathbf{e}}_2$. The instantaneous rear wheel radius is
\begin{equation}
