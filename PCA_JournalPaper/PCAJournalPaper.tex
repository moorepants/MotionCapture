...
The observations also revealed that other motions such as lateral movement of the knees
...
steering when employing a optimal control strategy on a
...
\begin{figure}
    \centering
        \includegraphics[height=3.61in]{figures/markerloc.pdf}
...
\begin{enumerate}
    ...
    \item How does the system motion change with respect to change in forward speed?
...
\begin{figure}[tbp]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/eigPlot.pdf}
    \end{center}
...
\begin{figure}[tbp]
    \begin{center}
        \includegraphics[width=4in]{figures/frames.pdf}
    \end{center}
...
(\ref{fig:coef3062}) and (\ref{fig:fft3062}) and noted down the shape of the
...
\begin{figure}[tb]
    \begin{center}
        \includegraphics[width=0.75\textwidth]{figures/coef3062.pdf}
    \end{center}
...
\begin{figure}[tb]
    \begin{center}
        \includegraphics[width=0.75\textwidth]{figures/fft3062.pdf}
    \end{center}
...
\begin{figure}[tbp]
    \begin{center}
        \subfloat[]{\label{fig:steerRoll}\includegraphics[width=20mm]{figures/rollSteer.pdf}}\qquad
        \subfloat[]{\label{fig:yaw}\includegraphics[width=20mm]{figures/yaw.pdf}}\qquad
        \subfloat[]{\label{fig:pedaling}\includegraphics[width=20mm]{figures/pedal.pdf}}\qquad
        \subfloat[]{\label{fig:bend}\includegraphics[width=20mm]{figures/bend.pdf}}

        \subfloat[]{\label{fig:lean}\includegraphics[width=20mm]{figures/lean.pdf}}\qquad
        \subfloat[]{\label{fig:twist}\includegraphics[width=20mm]{figures/twist.pdf}}\qquad
        \subfloat[]{\label{fig:bounce}\includegraphics[width=20mm]{figures/bounce.pdf}}\qquad
        \subfloat[]{\label{fig:knees}\includegraphics[width=20mm]{figures/knees.pdf}}
    \end{center}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/pedaling4classes.pdf}
...
\begin{figure}[tb]
    \centering
        \includegraphics[width=0.7\textwidth]{figures/towing3classes.pdf}\\
...
interaction, biomechanics and control led us to several conclusions. During
normal bicycling there are several dominant upper body motions: lean, bend, twist and
bounce and all of them seemed to be linked to the pedaling motion. This is important in
understanding when determining which inputs a for the fundamental balance
control and which inputs are reactions to disturbances from pedaling. Due to
this observation we hypothesize that lateral control is mainly done by steering
since we observed only upper body motion in the pedaling frequency. But if
upper body motions are used for control then this control is in the pedaling
frequency. Looking at motions with respect to speed, we observed that there is
a great deal of steering at low speeds and this decreases in magnitude as speed
increases. This is typically the same for all motions and it shows that the
bicycle and rider system becomes more stable at higher speeds with few
detectable control actions. At low speeds, one interesting lower body movement
presented itself. We observed lateral knee motions which may also be used for
additional control. The bicycle model that we present predicts that the weave
mode is stable above about 16 km/h. Intuition would possibly lead you to believe
that a rider would stabilize the weave mode at the same frequency as the open
loop uncontrolled bicycle stabilizes at but we found no evidence of a distinct
weave frequency in the steer angle time histories of each run. In fact the only
distinct frequency that sometimes appeared was the pedaling frequency. So the
rider's control mechanisms may be in fact different than what the open loop
stabilization predicts. Principle Component Analysis provided a unique view
into the control actions of a rider on a bicycle, but limitations in data
reduction and the motion grouping leave room for more objective statistical
views into the bicycle and rider motion.
